...
const About: React.FC = () => {
  ...
  const awards: AwardData[] = [
    ...
    },
    {
      ...
      image: isteImage,
      title: 'ISTE Award',
      subtitle: 'ISTE Best Student Award',
      description: 'Honored by ISTE for contribution to technical education, student development, and active participation in knowledge-sharing initiatives.',
